...
Run `20260922T222417746Z-30652` stages that correction with zero errors and 246 warnings but is not published: the four reactions also have blank Energy cost and cost kind, retaining `record-unready` diagnostics. Setting those costs to zero has been proposed separately and awaits the user's answer. No zero-cost rule has been inferred. The UI-message correction is prepared but not yet deployed.
